...
const requiredFields = ['hrCode', 'name', 'email', 'password', 'Role','phone', 'department'];
                  ...
                  <Grid item xs={field === 'currentAddress' ? 12 : 6} key={field}>
                    <TextField
                      ...
                      onChange={(e) => {
                        ...
                        if (field === 'placeOfIssue' || field === 'resident') {
                      ...
                      placeholder={
                        field === 'placeOfIssue'
                          ? 'Enter Place Of Issue (e.g. Chennai)'
                          : field === 'resident'
                      ...
                      placeholder={
                        field === 'accountName'
                          ...
                          : field === 'bankOfIssue'
                            ...
                            : 'Enter personal tax code (e.g. ABC123456)'
                      }
                      inputProps={{
                        maxLength:
                          field === 'accountName' || field === 'bankOfIssue' ? 50 : 20
                      }}
                    />
                  </Grid>
                ))} */}
